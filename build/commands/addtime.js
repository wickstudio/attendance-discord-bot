...
module.exports = {
  ...
  data: new discord_js_1.SlashCommandBuilder()
    ...
    .addUserOption((option) =>
      option
        .setName("user")
        .setDescription("الشخص الذي تريد إضافة الوقت له")
        .setRequired(true),
    )
    ...
    .addStringOption((option) =>
      option
        .setName("time")
        .setDescription("1m 1h 1d | الوقت الذي تريد اضافته")
        .setRequired(true),
    ),
        ...
        if (savedUser) {
          client.db.set(
            ...
            Object.assign(Object.assign({}, savedUser), {
              allTime: parseInt(savedUser.allTime + parseTime),
            }),
          );
        } else {
          client.db.set(
