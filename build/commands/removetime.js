...
module.exports = {
    ...
    data: new discord_js_1.SlashCommandBuilder()
        .setName('remove_time')
        .setDescription('ازالة وقت لشخص ما')
        .addUserOption((option) => option.setName('user').setDescription('الشخص الذي تريد ازالة وقت منه').setRequired(true))
        ...
        .setRequired(true))
        .addStringOption((option) => option.setName('time').setDescription('1m 1h 1d | الوقت الذي تريد ازالته').setRequired(true)),
    execute(client, interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const savedUser = yield client.db.get(`${interaction.guild.id},${user.user.id}_${field === null || field === void 0 ? void 0 : field.value}`);
                if (savedUser) {
                    client.db.set(`${interaction.guild.id},${user.user.id}_${field === null || field === void 0 ? void 0 : field.value}`, Object.assign(Object.assign({}, savedUser), { allTime: savedUser.allTime - parseTime }));
                }
                else {
                ...
                yield interaction.reply({ content: 'تم ازالة الوقت بنجاح', ephemeral: true });
            }
            catch (_a) {
