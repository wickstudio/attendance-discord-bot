    ...
    execute(client, interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (savedUser) {
                    client.db.set(`${interaction.guild.id},${user.user.id}_${field === null || field === void 0 ? void 0 : field.value}`, Object.assign(Object.assign({}, savedUser), { allTime: parseInt(savedUser.allTime + parseTime) }));
                }
                else {
